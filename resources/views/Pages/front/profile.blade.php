        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="card card-warning card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="images/dhan.jpg"
                                alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center">Dhan Magar</h3>

                        <p class="text-muted text-center">Jr. Engineer</p>

                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>Email</b> <a class="float-right">dhan.gharti.9@gmail.com</a>
                            </li>
                            <li class="list-group-item">
                                <b>Phone</b> <a class="float-right">9843625741</a>
                            </li>
                            <li class="list-group-item">
                                <b>Hash tag add items </b> <a class="float-right">#addItems</a>
                            </li>
                        </ul>
                ...
                <div class="card card-info">
                    <div class="card-header card-warning card-outline" style="background:grey">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                            B.S. in Computer Engineering from Kathmandu University Dhulikhel Kavre
                        </p>
                        ...
                        <p class="text-muted">Bhotebahal Kathmandu, Nepal</p>
                ...
                <div class="card">
                    <div class="card-header p-3">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Leave
                                    History</a>
                            </li>
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="images/dhan.jpg" alt="user image">
                                        <span class="username">
                                            <a href="#">Jonathan Burke Jr.</a>
                                            <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                        </span>
                                        <span class="description">Hello test</span>
                                    </div>
                                    <!-- /.user-block -->
                                    <p>
